...
To program the board, go through the whole process of **flashing nRF** [described here.](
https://developer.nordicsemi.com/nRF_Connect_SDK/doc/latest/nrf/ug_nrf9160_gs.html)

Use the nRF Connect Programmer with the downloaded `.hex` file and make [updating the application firmware](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/latest/nrf/ug_nrf9160_gs.html#updating-the-application-firmware) part.
Then reset the board and go to the [Connecting to the LwM2M Server](#connecting-to-the-lwm2m-server).
