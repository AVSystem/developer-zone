...
In this case we are going to use the `demo` application, so find the `demo_nrf9160dk_merged.hex` file and go to the [flashing part](#flash-the-binaries) of the tutorial.
