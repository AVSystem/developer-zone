...
To flash the board, open your **File Manager**, drag the .bin file to B-L462E-CELL1/TYPE1SC device. You will see the blinking diode on your board. As soon as the flashing is finished, the diode stops blinking.
