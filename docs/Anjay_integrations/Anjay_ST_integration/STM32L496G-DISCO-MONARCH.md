...
To flash the board you should drag the .bin file to STM32L496G-DISCO/MONARCH device which you can find in **devices and drives** part in **This PC**. You will see the blinking diode on your board. When the diode stop blinking it means that the board is flashed.
