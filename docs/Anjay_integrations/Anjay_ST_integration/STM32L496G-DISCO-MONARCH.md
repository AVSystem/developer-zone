...
To flash the board, drag the .bin file to STM32L496G-DISCO/MONARCH device which you can find in **devices and drives** part in **This PC**. You will see the blinking diode on your board. As soon as the diode stops blinking, the flashing has finished.
