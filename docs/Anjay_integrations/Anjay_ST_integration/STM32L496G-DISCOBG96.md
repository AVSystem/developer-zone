...
To flash the board, open your **File Manager**, drag the .bin file to STM32L496G-DISCO/BG96 device. You will see the blinking diode on your board. As soon as the flashing is finished, the diode stops blinking.
