...
To set an Observe operation in Azure IoT Central, you need to add a [Job](https://iotdevzone.avsystem.com/docs/Azure_IoT_Integration_Guide/Azure_IoT_Central_integration/Set_an_Observation/#set-up-an-observation) in the IoT Central application. As you can see in the **Devices > Raw data** tab, an Observation is represented in the following format:
