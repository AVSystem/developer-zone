...
Please be aware that certain headers cannot be overwritten when using a webhook. 
The following is a list of headers that are restricted and cannot be modified:
