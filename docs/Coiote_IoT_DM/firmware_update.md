...
Within Firmware update we distinguish:
...
If you choose to create basic Firmware update from an existing configuration, perform the following steps:
...
If you choose to create new, basic Firmware update, perform the following steps:
...
If you choose to create new, multi-component Firmware update, perform the following steps:
...
During the update process, the status of the firmware update can be monitored by reviewing the Resources:
