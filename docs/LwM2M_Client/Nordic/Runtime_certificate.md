...
## Introduction
Anjay library supports secure connection between device and server. Encryption can be achieved with the use of Pre-Shared Key as it was described in [nRF9160](nRF9160.md), [nRF7002](nRF7002.md) and [Thingy:91](Thingy91.md) pages or with certificate-based cryptography.
