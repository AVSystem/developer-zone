...
0. Set West manifest path to `Anjay-zephyr-client/demo`, manifest file to `west-nrf.yml`, and do `west update`:
    ...
    west update
    ```
0. Compile and flash the project for **nRF7002**:
    ```
...
0. Check your default credentials by following the instructions in the program:
    ...
    !!! note
        **nRF7002** connects to the Internet via a WiFi network. Remember to set the credentials of your network using `anjay config set wifi_ssid <value>` and `anjay config set wifi_password <value>`.
