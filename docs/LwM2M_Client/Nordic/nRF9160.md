...
0. Use the nRF Connect Programmer and flash the created `.hex` file onto the board. For more information, follow the [updating the application firmware](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/latest/nrf/ug_nrf9160_gs.html#updating-the-application-firmware) documentation.
