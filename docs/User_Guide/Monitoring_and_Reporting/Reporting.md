...
![Reports](images/reporting_1.png "Reports")
...
![Scheduling-report](images/reporting_2.png "Scheduling a report")

1. **Title** - use it to name a report.
2. **Template selection** - use it to select a template of a report. You can find more about templates in the [Templates](#templates) section.
...
5. **Output** - use it to select a format of the report, for example, PDF, HTML or CSV.
    ...
    ![Scheduling a report](images/reporting_3.png "Scheduling a report - GUI")
...
!!! note
    This rules concern only local report files, they do not affect files uploaded to a remote server using the [Transfers](#transfers) feature.
...
![Templates](images/reporting_4.png "Templates")
...
2. **Add new template** - use it to open a creation form. Check [Custom templates section](#custom-templates-creation) for more details.
...
![custom-templates-creation](images/reporting_5.png "Custom templates creation")
...
![Reports-configuration1](images/reporting_6.png "Reports configuration - 1")
...
2. **Output** - use it to select default output formats. You can use CSV, DOC, HTML, PDF, PPT or XLS.
    ...
    ![Reports-configuration2](images/reporting_7.png "Reports configuration - 2")

3. **Email address** - use it to add email addresses to which reports will be sent.
4. **Default retention policy** - look at the [Retention policy](#retention-policy) section for details.
