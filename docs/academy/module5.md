...
*<p class="text-center">Updating a device’s firmware using {{ coiote_long_name }}</p>*
...
* [Anjay firmware update documentation](https://docs.avsystem.com/hubfs/Anjay_Docs/FirmwareUpdateTutorial.html)
